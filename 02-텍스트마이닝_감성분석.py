...
while True:
    ...
    for i in comment:
        i = i.text.strip()
        if i == "관람객" or i == "스포일러가 포함된 감상평입니다. 감상평 보기":
            continue
        print(i)
...
bar3d.add("", x_axis, y_axis, [[d[1], d[0], d[2]] for d in data],
    is_visualmap=True, visual_range=[min(sentiment_result.values()), max(sentiment_result.values())], visual_range_color=range_color,
